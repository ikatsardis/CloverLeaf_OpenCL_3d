...
(void)
{
    ...
    else
    {
        ...
        for (size_t ii = 0;;)
        {
            ...
            {
                fprintf(stdout, "Platforms available:\n");
    ...
    catch (cl::Error e)
    {
        ...
        {
            fprintf(stdout, "Current platform:\n");

            std::vector<cl::Platform> cur_plat_vec(1, platform);

            listPlatforms(cur_plat_vec);

            DIE("Unable to get devices of desired type in current platform");
        }
        else
        {
